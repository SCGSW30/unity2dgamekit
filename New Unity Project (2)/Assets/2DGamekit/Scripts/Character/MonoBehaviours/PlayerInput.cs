...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton ReverseGravity = new InputButton(KeyCode.Z, XboxControllerButtons.A);
        ...
        protected override void GetInputs(bool fixedUpdateHappened)
        {
            ...
            ReverseGravity.Get(fixedUpdateHappened, inputType);
        ...
        public override void ReleaseControl(bool resetValues = true)
        {
            ...
            ReleaseControl(ReverseGravity, resetValues);
